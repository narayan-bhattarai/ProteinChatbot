...
export interface IChatService {
    getResponseOllamaGenerateAPI(promptValue: string | null | undefined): Observable<string>;
    getProteinDataByProteinName(proteinName: string | null | undefined): Observable<ProteinByName[]>;
    extractProteinDataByUniProtId(uniProtId: string | null | undefined): Observable<EssentialProteinResponseById>;
}
...
export class ChatService implements IChatService {
    ...
    getResponseOllamaGenerateAPI(promptValue: string | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/Chat/query-to-ollama?";
        if (promptValue !== undefined && promptValue !== null)
            url_ += "promptValue=" + encodeURIComponent("" + promptValue) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetResponseOllamaGenerateAPI(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetResponseOllamaGenerateAPI(response_ as any);
                } catch (e) {
    ...
    protected processGetResponseOllamaGenerateAPI(response: HttpResponseBase): Observable<string> {
    ...
    getProteinDataByProteinName(proteinName: string | null | undefined): Observable<ProteinByName[]> {
        let url_ = this.baseUrl + "/api/Chat/parse-protein-data-by-proteinName?";
        if (proteinName !== undefined && proteinName !== null)
            url_ += "proteinName=" + encodeURIComponent("" + proteinName) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProteinDataByProteinName(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProteinDataByProteinName(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ProteinByName[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ProteinByName[]>;
        }));
    }

    protected processGetProteinDataByProteinName(response: HttpResponseBase): Observable<ProteinByName[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(ProteinByName.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    extractProteinDataByUniProtId(uniProtId: string | null | undefined): Observable<EssentialProteinResponseById> {
        let url_ = this.baseUrl + "/api/Chat/extract-protein-data-by-uniProtId?";
        if (uniProtId !== undefined && uniProtId !== null)
            url_ += "uniProtId=" + encodeURIComponent("" + uniProtId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processExtractProteinDataByUniProtId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processExtractProteinDataByUniProtId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<EssentialProteinResponseById>;
                }
            } else
                return _observableThrow(response_) as any as Observable<EssentialProteinResponseById>;
        }));
    }

    protected processExtractProteinDataByUniProtId(response: HttpResponseBase): Observable<EssentialProteinResponseById> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EssentialProteinResponseById.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class ProteinByName implements IProteinByName {
    uniProtID?: string;
    proteinName?: string;
    ...
    constructor(data?: IProteinByName) {
        if (data) {
    ...
    init(_data?: any) {
        if (_data) {
            this.uniProtID = _data["uniProtID"];
            this.proteinName = _data["proteinName"];
            this.scientificName = _data["scientificName"];
            this.taxonID = _data["taxonID"];
            this.molecularWeight = _data["molecularWeight"];
        }
    }

    static fromJS(data: any): ProteinByName {
        data = typeof data === 'object' ? data : {};
        let result = new ProteinByName();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["uniProtID"] = this.uniProtID;
        data["proteinName"] = this.proteinName;
        data["scientificName"] = this.scientificName;
        data["taxonID"] = this.taxonID;
        data["molecularWeight"] = this.molecularWeight;
        return data;
    }
}

export interface IProteinByName {
    uniProtID?: string;
    proteinName?: string;
    scientificName?: string;
    taxonID?: number;
...
export class EssentialProteinResponseById implements IEssentialProteinResponseById {
    ...
    constructor(data?: IEssentialProteinResponseById) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.primaryAccession = _data["primaryAccession"];
    ...
    static fromJS(data: any): EssentialProteinResponseById {
        data = typeof data === 'object' ? data : {};
        let result = new EssentialProteinResponseById();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["primaryAccession"] = this.primaryAccession;
...
export interface IEssentialProteinResponseById {
    primaryAccession?: string;
    functions?: string;
    proteinName?: string;
    scientificName?: string;
