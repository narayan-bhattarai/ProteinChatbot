...
export interface IChatClient {
    callGenerateApi(promptValue: string | null | undefined): Observable<string>;
}
...
export class ChatClient implements IChatClient {
    ...
    callGenerateApi(promptValue: string | null | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/Chat/query?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCallGenerateApi(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCallGenerateApi(<any>response_);
                } catch (e) {
    ...
    protected processCallGenerateApi(response: HttpResponseBase): Observable<string> {
